...
const VerifyPage = lazy(() =>
  import("@/pages/auth/verify").then((m) => ({ default: m.VerifyPage })),
);
...
const CliAuthPage = lazy(() =>
  import("@/pages/auth/cli-auth").then((m) => ({ default: m.CliAuthPage })),
);
const AcceptInvitePage = lazy(() =>
  import("@/pages/auth/accept-invite").then((m) => ({ default: m.AcceptInvitePage })),
);
const GithubOAuthPage = lazy(() =>
  import("@/pages/auth/github-oauth").then((m) => ({ default: m.GithubOAuthPage })),
);
const GitlabOAuthPage = lazy(() =>
  import("@/pages/auth/gitlab-oauth").then((m) => ({ default: m.GitlabOAuthPage })),
);
const BitbucketOAuthPage = lazy(() =>
  import("@/pages/auth/bitbucket-oauth").then((m) => ({ default: m.BitbucketOAuthPage })),
);
const AzureOAuthPage = lazy(() =>
  import("@/pages/auth/azure-oauth").then((m) => ({ default: m.AzureOAuthPage })),
);
const GithubOAuthCompletePage = lazy(() =>
  import("@/pages/auth/oauth-complete").then((m) => ({ default: m.GithubOAuthCompletePage })),
);
const GitlabOAuthCompletePage = lazy(() =>
  import("@/pages/auth/oauth-complete").then((m) => ({ default: m.GitlabOAuthCompletePage })),
);
const BitbucketOAuthCompletePage = lazy(() =>
  import("@/pages/auth/oauth-complete").then((m) => ({ default: m.BitbucketOAuthCompletePage })),
);
const AzureOAuthCompletePage = lazy(() =>
  import("@/pages/auth/oauth-complete").then((m) => ({ default: m.AzureOAuthCompletePage })),
);

const DashboardLayout = lazy(() =>
  import("@/layout/dashboard").then((m) => ({ default: m.DashboardLayout })),
);
const DashboardHomePage = lazy(() =>
  import("@/pages/dashboard/home").then((m) => ({ default: m.HomePage })),
);
const DashboardPage = lazy(() =>
  import("@/pages/dashboard/dashboard").then((m) => ({ default: m.DashboardPage })),
);
const ProjectOverviewPage = lazy(() =>
  import("@/pages/projects/overview").then((m) => ({ default: m.ProjectOverviewPage })),
);
const LiveAnalysisPage = lazy(() =>
  import("@/pages/projects/live-analysis").then((m) => ({ default: m.LiveAnalysisPage })),
);
const DocumentationViewerPage = lazy(() =>
  import("@/pages/projects/documentation").then((m) => ({ default: m.DocumentationViewerPage })),
);
const ProjectSettingsPage = lazy(() =>
  import("@/pages/projects/settings").then((m) => ({ default: m.ProjectSettingsPage })),
);
const DocumentationsPage = lazy(() =>
  import("@/pages/dashboard/documentations").then((m) => ({ default: m.DocumentationsPage })),
);
const LogsPage = lazy(() =>
  import("@/pages/dashboard/logs").then((m) => ({ default: m.LogsPage })),
);
...
const PricingPage = lazy(() =>
  import("@/pages/guest/pricing").then((m) => ({ default: m.PricingPage })),
);
const PlatformDocsPage = lazy(() =>
  import("@/pages/guest/docs").then((m) => ({ default: m.PlatformDocsPage })),
);
const PublicPortalPage = lazy(() =>
  import("@/pages/docs/public-portal").then((m) => ({ default: m.PublicPortalPage })),
);
const SuperAdminPage = lazy(() =>
  import("@/pages/admin/super-admin").then((m) => ({ default: m.SuperAdminPage })),
);
const TermsPage = lazy(() => import("@/pages/guest/terms").then((m) => ({ default: m.TermsPage })));
const PrivacyPage = lazy(() =>
  import("@/pages/guest/privacy").then((m) => ({ default: m.PrivacyPage })),
);
const ContactPage = lazy(() =>
  import("@/pages/guest/contact").then((m) => ({ default: m.ContactPage })),
);
...
function AdminRoute({ children }: { children: React.ReactNode }) {
  ...
  return user?.role === "super-admin" ? <>{children}</> : <Navigate to="/home" replace />;
}
...
function getRouteSeo(pathname: string): SeoConfig | null {
  ...
  if (SYSTEM_PATHS.includes(pathname) || matchPath("/share/accept/:token", pathname)) {
    return {
