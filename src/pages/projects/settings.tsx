  ...
  const handleSync = useCallback(
    async (force = false) => {
      ...
      try {
        ...
        setProject((prev) =>
          prev ? { ...prev, apiStatus: "running", status: "analyzing" } : prev,
        );
                  ...
                  <>
                    ...
                    <Card className="shadow-none">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription className="text-[13px]">
                          Connect external tools to receive security alerts and query your
                          documentation.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          ...
                          {hasGithubSync &&
                            ...
                            webhookStatus?.webhookEnabled && (
                              <Badge
                                variant="outline"
                                className="text-[11px] gap-1 text-green-600 dark:text-green-400 border-green-500/40"
                              >
                        ...
                        <CardDescription className="text-[13px]">
                          Automatically re-analyze documentation when commits are pushed to this
                          repository.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {hasGithubSync ? (
                            ...
                            <div className="rounded-lg border border-border bg-muted/30 p-4 space-y-3">
                              <div className="flex items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  ...
                                  >
                                    <RefreshCw
                                      className={cn("h-3.5 w-3.5", syncLoading && "animate-spin")}
                                    />
                                ...
                                <p className="text-[12px]">
                                  ...
                                  {webhookStatus.lastWebhookAt && (
                                    <>
                                      {" "}
                                      Last received:{" "}
                                      {new Date(webhookStatus.lastWebhookAt).toLocaleDateString(
                                        undefined,
                                        {
                                          month: "short",
                                          day: "numeric",
                          ...
                          <div className="rounded-xl border border-dashed border-border bg-muted/20 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setUpgradeModal({ open: true, feature: "GitHub Sync", plan: "pro" })
                              }
                            >
                    ...
                    <Card className="shadow-none">
                      <CardHeader className="pb-3">
                        ...
                        <CardDescription className="text-[13px]">
                          Access your documentation via REST API and receive webhook events on doc
                          changes.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {hasWebhookAccess ? (
                          <div className="space-y-4">
                            <div className="rounded-lg border border-border bg-muted/30 p-4 space-y-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  {["doc.generated", "doc.section.updated", "security.alert"].map(
                                    (evt) => (
                                      <Badge
                                        key={evt}
                                        variant="secondary"
                            ...
                            <p className="text-[12px] text-muted-foreground">
                              ...
                              <a
                                href="https://docs.docnine.dev/api"
                                target="_blank"
                          ...
                          <div className="rounded-xl border border-dashed border-border bg-muted/20 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="space-y-1">
                              <p className="text-[13px] font-medium">
                                Upgrade to unlock API &amp; Webhooks
                              </p>
                              <p className="text-[12px] text-muted-foreground">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setUpgradeModal({
                                  ...
                                  plan: "team",
                                  description:
                                    "Access the DocNine REST API and configure webhooks to automate your documentation workflows.",
                                })
                              }
                            >
                              <Lock className="h-3 w-3" />
