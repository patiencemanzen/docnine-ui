      ...
      <CardContent className="pt-5 pb-4 px-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            {sub && !loading && <p className="text-[12px] text-muted-foreground mt-1.5">{sub}</p>}
          </div>
          <div
            className={cn(
  ...
  return (
    <div className="space-y-8 pb-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <Button onClick={() => navigate("/projects")} className="shrink-0 gap-1.5" size="sm">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          sub={
            stats.completed > 0
              ? `${Math.round((stats.completed / Math.max(stats.total, 1)) * 100)}% success rate`
              : "No docs yet"
          }
          loading={projectsLoading}
          accent="green"
              ...
              <CardContent className="flex flex-col items-center justify-center py-12 text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-muted-foreground mt-0.5">
                    Connect a repo and generate your first documentation.
                  </p>
                </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-1 shrink-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className={cn("text-[12px] font-medium", sc.className)}>
                          {sc.label}
                        </span>
                      </div>
          ...
          <Card className="border-border/60">
            ...
            <CardContent className="px-4 pb-4 space-y-3">
              {subLoading ? (
                ...
                <>
                  <UsageMeter label="Projects" used={projectsUsed} limit={projectLimit} />
          ...
          <Card className="border-border/60">
            <CardHeader className="pb-0 pt-4 px-4">
              <div className="flex items-center justify-between">
                ...
                {recentNotifs.length > 0 && <BarChart3 className="h-4 w-4 text-muted-foreground" />}
              </div>
            </CardHeader>
