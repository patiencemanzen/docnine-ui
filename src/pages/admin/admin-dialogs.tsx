      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {target ? (
              <>
                Grant or override the plan for <span className="font-medium text-foreground">{target.userName}</span>
          ...
          {plan !== "free" && (
            <>
              ...
              <div className="grid gap-1.5">
                ...
                <Select id="admin-cycle" value={billingCycle} onChange={(e) => setBillingCycle(e.target.value)}>
...
export function EditUserDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v && !saving && !signingOut) onClose() }}>
      <DialogContent>
        <DialogHeader>
        ...
        <div className="grid gap-4">
          ...
          <div className="rounded-md border border-border p-3 space-y-2">
            ...
            <Button variant="outline" size="sm" onClick={handleSignOut} disabled={signingOut || saving}>
        ...
        <DialogFooter>
          <Button variant="outline" onClick={onClose} disabled={saving || signingOut}>Cancel</Button>
